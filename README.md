...
- get card(id: string) - возвращает конкретный товар по id
...
- getItems(): Record<string, number> - возвращает объект (ключ - id, значение - количество в корзине)
...
- getItemCountById(id: string): number - возвращает количество конкретного товара в корзине по id
...
- price(value: number) - устанавливает цену товара
